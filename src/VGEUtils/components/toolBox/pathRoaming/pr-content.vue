<template>
  <win-tabs :initCSS="{width: 300,height: 280,left:350,top:380}" @close="close" class="move_box">
    <tab-pane label="路径漫游">
      ...
      <div style="margin-bottom: 5px" v-if="roamingType==='飞行漫游'">
        <el-row>
          <el-col :span="6">
      ...
      <div style="margin-bottom: 5px">
        <el-row>
          ...
          <el-col :span="14">
            <button class="btn btn-sm btn-success" @click="drawLine" :disabled="drawLineDone" style="margin-right: 5px">画线</button>
            <button class="btn btn-sm btn-warning" @click="stop" :disabled="!drawLineDone">清除</button>
          </el-col>
        </el-row>
      </div>
      ...
      <div style="margin-bottom: 5px">
        <el-row>
          ...
          <el-col :span="18">
            <button class="btn btn-info btn-sm" @click="start" :disabled="!drawLineDone" style="margin-right: 3px">开始</button>
            <button class="btn btn-info btn-sm" @click="pause" :disabled="!drawLineDone" style="margin-right: 3px">暂停</button>
            <button class="btn btn-info btn-sm" @click="accelerateUp" :disabled="!drawLineDone" style="margin-right: 3px">加速</button>
            <button class="btn btn-info btn-sm" @click="accelerateDown" :disabled="!drawLineDone">减速</button>

		...
		<div class="tab-content">
			<div id="tab1" class="tab-pane active">
				...
				<div style="min-height: 320px">
					...
					<div style="padding-top: 15px">
						连续标注：
						<el-button size="small" v-if="continuous===false" type="info" @click="continuous=!continuous">
							未开启
						</el-button>
						<el-button size="small" v-if="continuous===true" type="success" @click="continuous=!continuous">
							开启
						</el-button>
					</div>
				</div>

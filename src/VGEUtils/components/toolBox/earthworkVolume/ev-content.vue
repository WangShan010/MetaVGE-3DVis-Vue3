        ...
        <tab-pane label="土方量计算">
            <div @mousedown.stop>
                <div>
                    ...
                    <el-select v-model="selBackgroundDataId" clearable placeholder="请选择" size="small" @change="selTifDataGroup">
                        <el-option
                    ...
                    <template v-if="selBackgroundDataId">
                        <el-popconfirm title="确认从服务器上永久删除该 Tif 文件?" @confirm="delTif(selBackgroundDataId)">
                            <template #reference>
                                <el-button size="small" style="margin-left:10px" type="danger">删除</el-button>
                            </template>
                        </el-popconfirm>
                ...
                <div style="padding: 10px 0">
                    ...
                    <el-select v-model="selLandslideDataId" clearable placeholder="请选择" size="small" @change="selTifDataGroup">
                        <el-option
                            v-for="item in tifGroup"
                            :key="item.id"
                            :label="item.name"
                    ...
                    <template v-if="selLandslideDataId">
                        <el-button size="small" style="margin-left:10px" type="danger" @click="delTif(selLandslideDataId)">删除</el-button>
                ...
                <div v-if="earthworkVolumeData">
                    ...
                    <div class="resContent">
                        <div v-for="item in earthworkVolumeData.fields" class="dataFields">
                ...
                <div class="ctrBtns">
                    ...
                    <el-button :disabled="!(selBackgroundDataId&&selLandslideDataId)" size="small" type="primary" @click="selPolygon">框选范围</el-button>

            ...
            <div>
                <div>
                    <el-row class="form-item">
                        ...
                        <el-col :span="16">
                            <el-select v-model="farSkyBox"
                                       ...
                                       size="small" @change="setFarSkyBox">
                                <el-option
                    ...
                    <el-row class="form-item">
                        ...
                        <el-col :span="16">
                            <el-select v-model="groundSkyBox"
                                       clearable placeholder="请选择" size="small" @change="setGroundSkyBox">
                                <el-option
                    ...
                    <div style="text-align: center;padding-top: 10px">
                        <button class="btn btn-primary btn-sm" style="margin-right: 5px;margin-left: 80px" @click="flyToFar">远景</button>

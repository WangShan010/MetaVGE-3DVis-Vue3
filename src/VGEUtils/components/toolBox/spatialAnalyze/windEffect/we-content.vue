<template>
  <win-tabs :initCSS="{width: 350,height: 280,left:500,top:330}" @close="close" v-loading="loading" element-loading-text="拼命加载中" >
    <tab-pane label="风力效应">
      <div class="we-content">
        <div>
          ...
          <div style="text-align: center;margin-bottom: 10px">
            <el-select v-model="analyze"  style="width: 150px; margin-right: 10px"
                       @change="change">
              <el-option
...
export default {
  ...
  mounted() {
    // 设置默认显示第一行的值
    this.analyze = this.analyzes[0].value;

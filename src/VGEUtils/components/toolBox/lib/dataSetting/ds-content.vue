      ...
      <div>
        ...
        <div style="margin-bottom: 5px">
          <el-row>
            ...
            <el-col :span="16">
              <el-slider v-model="opts.height" @input="update3DTilesMatrix" :min="-100" :max="1000"></el-slider>
            </el-col>
          </el-row>
        </div>
        <div style="margin-bottom: 5px">
          <el-row>
            ...
            <el-col :span="16">
              <el-slider v-model="opts.rx" @input="update3DTilesMatrix" :min="-100" :max="100"></el-slider>
            </el-col>
          </el-row>
        </div>
        <div style="margin-bottom: 5px">
          <el-row>
            ...
            <el-col :span="16">
              <el-slider v-model="opts.ry" @input="update3DTilesMatrix" :min="-100" :max="100"></el-slider>
            </el-col>
          </el-row>
        </div>
        <div style="margin-bottom: 5px">
          <el-row>
            ...
            <el-col :span="16">
              <el-slider v-model="opts.rz" @input="update3DTilesMatrix" :min="-100" :max="100"></el-slider>
            </el-col>
          </el-row>
        </div>

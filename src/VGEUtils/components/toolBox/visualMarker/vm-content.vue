                ...
                <div>
                    <div class="sm-function-module-sub-section" style="margin-bottom: 5px">
                        <el-row>
                            ...
                            <el-col :span="11">
                                <input v-model="name" class="sm-input-long" min="0" style="float: none;width: 100%;height:30px"
                                       type="text"/>
                            </el-col>
                            <el-col :span="10" style="text-align: center">
                                <div class="btn-group" role="group">
                                    ...
                                    <button v-if="canImport" class="btn btn-success btn-sm" style="margin-right: 5px" type="button"
                                            @click="importMarkers">导入
                                    </button>
                                    <button v-if="canExport" class="btn btn-warning btn-sm" type="button" @click="exportMarkers">导出
                                    </button>
                                </div>
                            </el-col>
                        </el-row>
                    ...
                    <div id="markerContent">
                        <div v-for="mark in markers" class="mark" style="margin-bottom: 5px">
                            <el-row>
                                ...
                                <el-col :span="12">
                                    <img :style="{width:imageWidth+'px'}" v-bind:src="mark.img" @click="flyTo(mark.cameraView)"/>

<template>
    <div>
        <div class="vge-functionBar" v-if="show">
            <div class="vge-functionBar-btns">
                <div @click="changeSelected('baseMap')" v-if="false">
                    <img v-if="selected === 'baseMap'" :src="baseMapSelected" alt="">
                    <img v-else src="../assets/img/base-map.png" alt="">
                    <span :style="{color: selected === 'baseMap' ? baseColor : '#fff'}">底图</span>
                </div>
                <div @click="changeSelected('toolBox')">
                    <img v-if="selected === 'toolBox'" :src="toolSelected" alt="">
                    <img v-else src="../assets/img/tool.png" alt="">
                ...
                <div @click="changeSelected('resourceTree')">
                    ...
                    <img v-else src="../assets/img/layer.png" alt="">
